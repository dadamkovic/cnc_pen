...
#define defaults_h
  ...
  #define DEFAULT_X_ACCELERATION 1000.0 // may need changes 10*60*60 mm/min^2 = 10 mm/sec^2
  #define DEFAULT_Y_ACCELERATION 1000.0 // may need changes 10*60*60 mm/min^2 = 10 mm/sec^2
  #define DEFAULT_Z_ACCELERATION 1000.0 // may need changes 10*60*60 mm/min^2 = 10 mm/sec^2
